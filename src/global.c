...
//下面的大小只是用作测试
unsigned long NSMRBands = 5;		// 5*36MB~180MB
unsigned long NSMRBlocks = 5;		// 5*8KB~40kB
unsigned long NSSDs = 5;		// 5*8KB~40kB
...
char smr_device[] = "/Users/taoliu/smr-test/smr-ssd-cache/src/smr";
char ssd_device[] = "/Users/taoliu/smr-test/smr-ssd-cache/src/ssd";
char inner_ssd_device[] = "/Users/taoliu/smr-test/smr-ssd-cache/src/inner_ssd";
